"""
Django settings for nk_electronics project.
...
SECRET_KEY = 'django-insecure-d^(4k9i_-763o!-i*squy7nx^ua!j!o!egudh_(ue5so*bhrvx'
...
ROOT_URLCONF = 'nk_electronics.urls'
...
WSGI_APPLICATION = 'nk_electronics.wsgi.application'
